...
public class EX4_TESTER {
    ...
    public static void main(String[] args) {
        ...
        gc.setConfFile("/Users/ccg/Desktop/empty.conf"); // change to the exact loaction where you put the file.
        gc.create();

        // empty file should not create any agents
        if (Thread.activeCount() != c) {
            System.out.println("your code did not create the right number of threads (-10)");
        }

        // case where the number of lines is not a multiple of 3
        gc.setConfFile("/Users/ccg/Desktop/simple3.conf");// change to the exact loaction where you put the file.
        gc.create();
        ...
        gc.setConfFile("/Users/ccg/Desktop/simple.conf"); // change to the exact loaction where you put the file.
        gc.create();
